...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Jun-2022 às 20:42
...
--
CREATE DATABASE IF NOT EXISTS `cadastro_ong` DEFAULT CHARACTER SET utf8 COLLATE utf8_estonian_ci;
USE `cadastro_ong`;
...
-- Procedures
--
DROP PROCEDURE IF EXISTS `insere_dependente`$$
...
DROP PROCEDURE IF EXISTS `seleciona_dependente`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `seleciona_dependente` ()  BEGIN
SELECT * FROM dependente;
END$$

DROP PROCEDURE IF EXISTS `seleciona_titular`$$
...
CREATE TABLE `fornecedor` (
  `cnpj` char(14) COLLATE utf8_estonian_ci NOT NULL,
  `razao_social` varchar(60) COLLATE utf8_estonian_ci NOT NULL,
  `endereco` varchar(60) COLLATE utf8_estonian_ci NOT NULL,
  `cidade` varchar(30) COLLATE utf8_estonian_ci NOT NULL,
  `estado` char(2) COLLATE utf8_estonian_ci NOT NULL,
  `telefone` char(10) COLLATE utf8_estonian_ci NOT NULL,
  `email` varchar(40) COLLATE utf8_estonian_ci NOT NULL,
  `marca` varchar(20) COLLATE utf8_estonian_ci NOT NULL,
...
DROP TABLE IF EXISTS `programas_habitacionais`;
